...
export default (app) => {
    ...
    app.use(checkRole && role === "SISWA" ? createAuth({
        ...
        options: {
            ...
            stores: [import.meta.env.VITE_AUTH_STORAGE],
            // stores: ['cookie'],
            tokenDefaultKey: `${config.STORAGE_KEY}/token`,
            tokenImpersonateKey: `${config.STORAGE_KEY}/tokenImpersonateKey`,
            rememberkey: `${config.STORAGE_KEY}/rememberkey`,
            rolesKey: 'role',
