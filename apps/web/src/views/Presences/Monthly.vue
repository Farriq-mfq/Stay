...
<template>
    <div>
        <div class="field">
            ...
            <Calendar v-model="filterDate" placeholder="Pilih Bulan dan Tahun" view="month" dateFormat="yy/mm"
                showButtonBar :manualInput="false" class="mt-3 w-full" />
