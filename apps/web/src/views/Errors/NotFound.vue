...
<template>
    <div
        ...
        <div class="flex flex-column align-items-center justify-content-center">
            <div
                style="border-radius: 20px; padding: 0.3rem; background: linear-gradient(180deg, rgba(33, 150, 243, 0.4) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center"
                    ...
                    <div class="text-600 mb-5 text-center">Kami tidak dapat menemukan halaman yang Anda cari. Coba periksa kembali URL atau kembali ke halaman utama.</div>
